...
public class ViewPagerBarnnerBitmap extends RelativeLayout implements OnPageChangeListener{
	/**
	 * ViewPager对象
	 */
	...
	public ViewPagerBarnnerBitmap(Context context) {
		this(context,null);
	}

	public ViewPagerBarnnerBitmap(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		indicatorBigSize = typedArray.getDimension(R.styleable.ViewPager_indicatorBigSize, 0);
		...
		indicatorMarginBottom = typedArray.getDimension(R.styleable.ViewPager_indicatorMarginBottom, 5);
		typedArray.recycle();
		initViews();
	}
